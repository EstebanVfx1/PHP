    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="agregar_proveedor.php" class="active">
          ...
          <div class="card col-auto">
            <div class="card-body">
              <h5 class="card-title">Agregar Nuevo Proveedor</h5>
                ...
                <form action="insert_db_proveedor.php" method="POST">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="inputNumber" class="col-sm-2 col-form-label">Direccion</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" value="Enviar" class="btn btn-primary">Agregar Proveedor</button>
                        </div>
                    </div>
