              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a type="button" class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#editar<?php echo $row['id_proveedor']?>">
                          <i class="ri-edit-box-line"></i>
                        </a>
                        <a class="btn btn-outline-danger" href="eliminar_proveedor.php?id_proveedor=<?php echo $row['id_proveedor'] ?>">
