    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="agregar_producto.php" class="active">
            ...
            <div class="card-body">
              ...
              <form action="insert_producto.php" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 300px" name="descripcion"></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" name="select_proveedor" aria-label="Default select example">
                      ...
                      ?>
                      <option value="<?php echo $row['id_proveedor'] ?>"><?php echo $row['id_proveedor'] ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
